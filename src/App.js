...
import roxo from '../src/assets/images/roxo.png';
...
function App() {
  ...
  async function buscarMais() {
    ...
    let url = "https://www.omdbapi.com?apikey=d712d5e5&s=" + filme + '&page=' + (pagina+1)
    let response = await axios.get(url);
    setLista([...lista, ...response.data.Search])
  }


  async function buscaFilme(){
    let url = "https://www.omdbapi.com?apikey=d712d5e5&s=" + filme + '&page=' + pagina
    let response = await axios.get(url);
      ...
      <section>
        <div className='conteudo'>
          ...
          <div className='consulta'>
            ...
            <div className='hadouken'>
            <button onClick={buscarMais} id="myBtn">Read more</button>
            </div>
          </div>
        </div>
      </section>
